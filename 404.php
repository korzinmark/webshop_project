...
<body>
    ...
    <section class="promo" style="background: url('<?php echo bloginfo('template_url'); ?>/assets/img/404.jpg') center center/cover no-repeat;background-image: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)) , url('<?php echo bloginfo('template_url'); ?>/assets/img/404.jpg');background-color: #000;">
        <header>
            <div class="container">
                <nav class="menu">
                    <ul class="menu__list">
        ...
        <div class="container">
            <div class="promo__wrapper">
                <h1 class="promo__title">Looks like you got the wrong page. Return home?</h1>
                <a href="<?php echo get_home_url(); ?>" class="promo__btn">Return home</a>
            </div>
        </div>
</section> 
<?php 
