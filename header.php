...
<body>
    ...
    <style>
        .aboutUs{background:url(<?php the_field('about_us_bg'); ?>) center center/cover no-repeat;background-image:linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5)),url(<?php the_field('about_us_bg'); ?>)}
        .contacts{background:url(<?php the_field('contacts_bg'); ?>) center center/cover no-repeat;background-image:linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5)),url(<?php the_field('contacts_bg'); ?>)}
    </style>
    <header class="header">
        <div class="container">
            <nav class="menu">
